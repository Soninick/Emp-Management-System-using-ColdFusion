...
<cfparam name="Signupsubmitbutton" default= 0>
  <cfif Signupsubmitbutton>
      <!--- <cfdump var="#isDefined(form.Signupsubmitbutton)#"> --->
      <!--- <cfdump var = "#form#"> --->
      <cfset u_firstname="#firstname#">
      <cfset u_lastname="#lastname#">
      <cfset u_emailid="#emailid#">
      <cfset u_enter_password="#enter_password#">
      <cfquery name="employees" datasource="EMPDATA">
          insert into employee_details(`first_name`,`last_name`,`email`,`password`)       
          values('#u_firstname#','#u_lastname#','#u_emailid#','#u_enter_password#')
      </cfquery>
                  ...
                  <form class="row g-3 needs-validation" action=""   
                   enctype="multipart/form-data" >
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="enter_password" class="form-control" id="yourPassword" required>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" 
                       name="Signupsubmitbutton" value="1" >Create Account</button>
                    </div>
                    <div class="col-12">
